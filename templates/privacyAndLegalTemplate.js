function getPrivacyPolicyTemplate(){
    return `
            <div class="privacy_and_legal_privacy_plolicy_text_container">
                ...
                <p>Welcome to <span class="pp_highlight">Developer Akademie</span>. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <span class="highlight">info@developerakademie.com</span>.</p>
                ...
                <h2>6. Contact Us</h2>
                <p>If you have questions or comments about this policy, you may email us at <span class="highlight">info@developerakademie.com</span> or by post to:</p>
                <p class="pp_contact_details">Developer Akademie<br>Tassiopl 25<br>84541 München Deutschland</p>
            
                <h1 class="pp_highlight">Datenschutzrichtlinie</h1>
                <p>Gültigkeitsdatum: 13 Dezember 2024</p>
            
                <h2>1. Einführung</h2>
                <p>Willkommen bei <span class="highlight">Developer Akademie</span>. Wir verpflichten uns, Ihre persönlichen Daten und Ihr Recht auf Privatsphäre zu schützen. Wenn Sie Fragen oder Bedenken bezüglich unserer Richtlinie oder unserer Praktiken in Bezug auf Ihre persönlichen Informationen haben, kontaktieren Sie uns bitte unter <span class="highlight">info@developerakademie.com</span>.</p>
