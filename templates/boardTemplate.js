...
function ticketTemplate(ticketID, category, ticketTitle, ticketDescription, prio, subtaskDone, allSubtasks, ticketDate) {
    return `<div class="ticket-card" draggable="true" ondragstart="startDragging('${ticketID}')" onclick="toggleOverlay(); showOverlayTicket('${category}', '${ticketTitle}', '${ticketDescription}', '${ticketDate}', '${prio}', '${ticketID}')">
...
function renderOverlayTicket(category, ticketTitle, ticketDescription, ticketDate, prio, ticketID) {
    return `<div class="overlay-card">
            ...
            <div class="overlay-assigned-wrapper">
                ...
                <div class="overlay-assigned-user-content" id="overlayAssignedUserContent_${ticketID}">
            ...
            <div class="overlay-subtasks-wrapper">
                ...
                <div class="overlay-subtasks-content" id=overlaySubtasksContent_${ticketID}>

                </div>
            </div>
            <div class="overlay-service-btn-wrapper">
                <div class="overlay-ticket-delete">
