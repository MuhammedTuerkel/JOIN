...
function loadLoginTemplate() {
  ...
  (loginPage.innerHTML = ""), (loginPage.innerHTML += getUserLoginTemplate());
...
function checkLoginInputfields() {
  ...
  const isEmailValid = emailInput.value.length >= 3;
  ...
  if (isEmailValid && isPasswordValid) {
    ...
    document.getElementById("loginInputPassword").classList.remove("login_input_error");
    document.getElementById("loginInputMail").classList.remove("login_input_error");
